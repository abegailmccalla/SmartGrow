            ...
            <v-row class="rounded-t-lg mb-1 pa-5" align="center" justify="center">
                <v-col cols="12" align="center">
                    <v-card class="text-secondary" title="Crop Selection" color="surface" elevation="0">
                        <!-- 'Tomato', 'Cucumber', 'Pepper', 'Lettuce', 'Spinach', 'Kale', 'Basil', 'Cilantro', 'Parsley', 'Chives' -->
                        <v-select class="text-secondary" dense v-model="crops.name" :items="['rice', 'maize', 'chickpea', 'kidneybeans', 'pigeonpeas', 'mothbeans', 'mungbean', 'blackgram', 'lentil', 'pomegranate', 'banana', 'mango', 'grapes', 'watermelon', 'muskmelon', 'apple', 'orange', 'papaya', 'coconut', 'cotton', 'jute', 'coffee']" label="Select Crop" item-text="name" item-value="name" color="secondary" prepend-icon="mdi:mdi-sprout"></v-select>
                    </v-card>
